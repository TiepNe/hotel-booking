...
const ListRoom = () => {
    ...
    // Lấy danh sách phòng của chủ khách sạn
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Danh Sách Phòng' subTitle='Xem, chỉnh sửa 
      và quản lý các phòng đã đăng. Duy trì thông tin luôn chính xác và cập nhật.'/>
                ...
                <tr key={index}>
                    ...
                    text-center'>
                        ...
                        text-gray-900 gap-3'>
                            ...
                            type="checkbox" className='sr-only peer' checked={item.
                            isAvailable}/>
