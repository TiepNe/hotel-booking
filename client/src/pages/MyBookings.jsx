...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <Title title='Đặt Phòng Của Tôi' subTitle='Dễ dàng quản lý các đặt phòng khách sạn 
      trước đây, hiện tại và sắp tới của bạn. Lên kế hoạch cho chuyến đi của bạn 
      thật thuận tiện chỉ với vài thao tác đơn giản.' align='left' />
            ...
            {bookings.map((booking)=>(
                ...
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div className='flex items-center gap-1 text-sm text-gray-500'>
                        ...
                        <span>Số lượng khách: {booking.guests}</span>
                    </div>
                ...
                <div className='flex flex-col items-start justify-center pt-3'>
                    ...
                    {!booking.isPaid && (
                        <button onClick={()=>handlePayment(booking._id)} className='px-4 
                        py-1.5 mt-4 text-xs border border-gray-400 rounded-full 
