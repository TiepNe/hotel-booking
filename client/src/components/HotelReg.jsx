...
const HotelReg = () => {
    ...
    const onSubmitHandler = async (event)=>{
        try {
            ...
            const {data} = await axios.post(`${BACKEND_URL}/api/hotels`, 
      ...
      className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
            ...
            <div className='w-full mt-4'>
                ...
                {name} type="text" placeholder='Nhập ...' className='border 
            ...
            <div className='w-full mt-4'>
                ...
                id='contact' type="text" placeholder='Nhập ...' className='border 
                border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 
                font-light' required/>
            </div>
            {/* Địa Chỉ */}
            <div className='w-full mt-4'>
                ...
                <input onChange={(e)=> setAddress(e.target.value)}  value=
                {address} id='address' type="text" placeholder='Nhập ...' className='border 
                border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 
                font-light' required/>
            </div>
            ...
            <div className='w-full mt-4 max-w-60 mr-auto'>
                ...
                id="city" className='border border-gray-200 rounded w-full 
